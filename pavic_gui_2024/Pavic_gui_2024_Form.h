...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bt_open->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->bt_close->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->bt_exit->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pbox_input->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pbox_copy->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pbox_output->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->bt_copy->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			// bt_filter_bw
			// 
			this->bt_filter_bw->Location = System::Drawing::Point(9, 176);
			this->bt_filter_bw->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->bt_close_copy->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->bt_close_output->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->ClientSize = System::Drawing::Size(1206, 596);
